...
def schedule(ind):
    a = [0.001, 0.001, 0.0005, 0.0001, 0.0001]
    return a[ind] 
...
model.fit(Xtrain, ytrain, batch_size=batch_size, epochs=epochs, validation_data=(Xval, yval), callbacks = [ra_val, es, mc] ,verbose=2)
