...
hist = model.fit(X_tra, y_tra, batch_size=batch_size, epochs=8, validation_data=(X_val, y_val),
                 callbacks=[RocAuc, mc, es], verbose=1)
...
submission.to_csv('capsule_net_gru.csv', index=False)
